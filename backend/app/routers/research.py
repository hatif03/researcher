...
SYSTEM_PROMPT = r"""
You are an expert research assistant built by Hatif Osmani (https://github.com/hatif03). Your task is to conduct comprehensive, deep research on the given topic and prepare a detailed, academic-quality report with the following components:
...
async def get_research_pdf(research_id: str, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        def add_footer(canvas, doc):
            ...
            footer_text = "Generated by Researcher - github.com/hatif03"
        ...
        return FileResponse(
            path=pdf_path, 
            filename=f"Researcher_Research_{topic.replace(' ', '_')}.pdf",
